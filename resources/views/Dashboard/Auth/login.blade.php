						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="login-separater text-center mb-4"> <span>SIGN IN WITH EMAIL OR PHONE</span>
										<hr/>
									</div>
									<div class="form-body">
										<form class="row g-3" action="{{ route('admin.login') }}" method="POST">
											...
											<div class="col-12">
												...
												<input type="text" class="form-control" id="inputEmailAddress" placeholder="Email or Phone" name="email">
											</div>
											<div class="col-12">
