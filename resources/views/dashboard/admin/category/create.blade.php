...
@section('subtitle', __('words.create_category'))
@section('content')
    <div class="row">
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">{{ __('words.create_category') }}</h5>
                    </div>
                    <hr>
                    <form class="row g-3" action='{{ route('categories.store') }}' method="POST">
                        ...
                        <div class="col-12 d-flex">
                            <button type="submit"
                                class="btn btn-primary px-5 ms-auto">{{ __('words.create_category') }}</button>
                        </div>
                    </form>
                </div>
            </div>
