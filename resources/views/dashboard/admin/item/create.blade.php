...
@section('home', '/items')
@section('subtitle', __('words.create_item'))
@section('content')
    <div class="row">
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">{{ __('words.create_item') }}</h5>
                    </div>
                    <hr>
                    <form class="row g-3" action='{{ route('items.store') }}' method="POST">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent">
                                ...
                                <input class="form-control" type='number' step="0.1" name="quantity" id="regions" class="mb-3">
                            </div>
                            @error('quantity')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent">
                                ...
                                <input class="form-control" type='number' name="calories" id="regions" class="mb-3">
                            </div>
                            @error('calories')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="col-12 d-flex">
                            <button type="submit"
                                class="btn btn-primary px-5 ms-auto">{{ __('words.create_item') }}</button>
                        </div>
                    </form>
                </div>
            </div>
